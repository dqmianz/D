...
Command.Add(
   {"UnAnchorGUI", "UAG"}
   {"UnAnchorGUI / UAG," "Gives you a GUI for freezing and spamming unanchored parts."},
   {"Nothing"},
   function()
...
Command.Add(
    {"Telekenisis," "TEL"}
    {"Telekenisis / TEL," "Allows you to move unanchored parts aslong as you are the closest one there"},
    {"Nothing"},
    function()
...
Command.Add(
	{"UnUWU", "Unuwu"},
	{"UnUWU / Unuwu", "Stops the dumbass command"},
	{"None"},
	function()
